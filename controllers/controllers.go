...
import (
	...
	generate "github.com/Maryu47/ecommerce-bill/tokens"
...
func SearchProductByQuery() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		searchquerydb, err := ProductCollection.Find(ctx, bson.M{"product_name": bson.M{"$regax": queryParam}})
